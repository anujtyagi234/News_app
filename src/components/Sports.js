...
export class Sports extends Component {
    ...
    async componentDidMount() {
        let url = "https://newsapi.org/v2/top-headlines?category=sports&country=in&apiKey=971b5cb64c0b477fab14a2fede604e1a&page=1&pageSize=20";
    ...
    handlePrevClick = async () => {
        let url = `https://newsapi.org/v2/top-headlines?category=sports&country=in&apiKey=971b5cb64c0b477fab14a2fede604e1a&page=${this.state.page - 1}&pageSize=20`;
        this.setState({loading:true})
        let data = await fetch(url);
        let parsedData = await data.json();
        this.setState({loading:false})
